    ...
    Object.getOwnPropertyNames(Object.getPrototypeOf(target)).forEach(function (propKey) {
        if (propKey !== 'constructor') {
            Object.defineProperty(result, propKey, {
                enumerable: true,
                get: memoize(function () { return getProperty(propKey.endsWith('Sync') ? ProxyPropertyType.FunctionSync : ProxyPropertyType.Function, propKey, target.channel, transport); })
            });
        }
    });
