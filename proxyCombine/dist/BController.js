...
var B = /** @class */ (function (_super) {
    __extends(B, _super);
    function B() {
        var _this = _super.call(this, B.name) || this;
        _this.attr = 1;
        _this.attr2 = 200;
        return _this;
    }
    B.prototype.CMCC = function () {
        console.log('.....10086.....');
        return 10086;
    };
    B.prototype.WCDMA = function (num) {
    ...
    B.prototype.CDMA = function (callback) {
        console.log('.....10000.....');
        for (var i = 0; i < 10; i++) {
    ...
    B.prototype.funcReply = function (num, sender) {
        return __awaiter(this, void 0, void 0, function () {
            var i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) { return setTimeout(resolve, 2000); })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
